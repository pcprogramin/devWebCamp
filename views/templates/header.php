<header class="header">
    ...
    <nav class="header__navegacion">
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">OCTUBRE5-6-2023</p>
            <p class="header__texto header__texto--modalidad">En Línea - Prensencial</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="/workshops-conferencias" class="navegacion__enlace <?php echo pagina_actual('/workshops-conferencias') ? 'navegacion__enlace--actual': '' ?>">Workshops / Conferencia</a>
