<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <?php if (isset($ponente->imagen_acutal)) { ?>
            <p class="formulario__texto">Imagen Actual:</p>
            <div class="formulario__imagen">
                <picture>
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen . '.webp' ?>" type="imagen/webp">
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen . '.png' ?>" type="imagen/png">
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label class="formulario__label" for="tag_input">Áreas de Experiencia (separadas por coma)</label>
